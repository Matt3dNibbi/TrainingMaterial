...
addOp.setSourceCode(open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '3_basicMath.kl')).read())
...
mulOp.setSourceCode(open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '3_basicMath.kl')).read())
