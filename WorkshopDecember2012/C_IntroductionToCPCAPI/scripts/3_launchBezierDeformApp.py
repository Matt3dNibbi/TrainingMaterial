...
Application.applyCPTopoIOOP("", "3_BezierDeformApp.DeformedMesh", False, "ToCreation")
Application.applyCPTopoIOOP("", "3_BezierDeformApp.DeformedMesh", True, "FromCreation")

Application.SIAddProp("CPRenderOptions", "Scene_Root", "siDefaultPropagation", "CPRenderOptions", "")

Application.SetExpr("polymsh.polymsh.FromCreation.input", "CPRenderOptions.evalID * 0", "")
